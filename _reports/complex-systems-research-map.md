...
{% include figure.liquid path=page.image title="Concept map" class="img-fluid rounded" %}

This is placeholder seed content for taxonomy and layout QA — a real concept map export will replace this image.
